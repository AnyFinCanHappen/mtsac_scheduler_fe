            ...
            >
              <Popover id="popover-basic">
                <Button
                  ...
                  onClick={(e) => this.handleDelete(e, popoverData.CRN)}
                >
                  <img
                ...
                <Popover.Content>
                  ...
                  <span style={{ paddingRight: '20px' }}>{'Color: '}</span>
                  <button
                    style={{
                      backgroundColor:
                        '#' + selectedCourses[popoverData.CRN].color,
                      color: '#' + selectedCourses[popoverData.CRN].color,
                    }}
                  ...
                  {colorList.map((item, index) => {
                    ...
                    return (
                      <React.Fragment key={item + index + popoverData.CRN + 3}>
                        <span
                          className="span-padding"
                          key={item + index + popoverData.CRN + 2}
                        >
                          <button
                            ...
                            onClick={() => {
                              this.changeColor(popoverData.CRN, item);
                            }}
