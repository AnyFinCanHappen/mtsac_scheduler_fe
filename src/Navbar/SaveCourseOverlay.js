            ...
            <Form>
              <Form.Group controlId="getUsername">
                ...
                <div>
                  ...
                  <input
                    type="checkbox"
                    checked={isSaveLocal === true}
                    onClick={this.handleRadioChange}
                    onChange={() => {}}
                  />
                  {' Save Locally(uncheck for shared devices)'}
                </div>
                {isError && (
                ...
                {isSaving && <Form.Text>Saving</Form.Text>}
                {!isSaving && resultCode === classSuccessCode && (
                  <Form.Text>Save successful</Form.Text>
                )}
                {!isSaving &&
                  resultCode !== null &&
                  resultCode !== classSuccessCode && (
                    <Form.Text>Save unsuccessful</Form.Text>
                  )}
              </Form.Group>
