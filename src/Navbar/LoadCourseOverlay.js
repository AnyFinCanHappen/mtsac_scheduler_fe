            ...
            <Form>
              <Form.Group controlId="getUsername">
                ...
                <div>
                  ...
                  <input
                    type="checkbox"
                    checked={isLoadLocal === true}
                    onClick={this.handleRadioChange}
                    onChange={() => {}}
                  />
                  {' Load Locally(uncheck for shared devices)'}
                </div>
                {isError && (
                  <Form.Text style={{ color: 'red' }}>{errorMessage}</Form.Text>
                )}
                {isLoading && <Form.Text>Loading</Form.Text>}
                {!isLoading && resultCode === classLoadCode && (
                  <Form.Text>Load successful</Form.Text>
                )}
                {!isLoading &&
                  resultCode !== null &&
                  resultCode !== classLoadCode && (
                    <Form.Text>Load unsuccessful</Form.Text>
                  )}
              </Form.Group>
